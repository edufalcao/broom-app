...
- 1.5.0 shipped (2026-08-22): all three locked features delivered — Installers mode, Project Artifacts sidebar section, uninstall preview trust — tested (206 unit + 4 UI), released as v1.5.0 with DMG asset. Destination reached; the way from scope lock to shipped releases is fully walked.
